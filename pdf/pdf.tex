...
\title{Code and summary}
\author{Jensen Lee, Gabe Valletto, Liam Ziegenhorn}
...
\section{Code for Data Processing}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\linewidth]{../outputData/C60_00_cycle_day_average.png}
    \caption{EQE of the C60 zero cycle group}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\linewidth]{../outputData/C60_05_cycle_day_average.png}
    \caption{EQE of the C60 zero cycle group}
\end{figure}
